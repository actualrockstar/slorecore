  ...
  return (
    <div className="items-left justify-items-left min-h-screen p-8 sm:p-20 ">
      <main className="flex flex-col row-start-2 items-left sm:items-start">
        ...
        <br></br>
        <Image src={'https://urbosdur9qrkencr.public.blob.vercel-storage.com/triggerwarning_cover.png'} width={600} height={300} alt='slorecore cover'></Image>
        <p className="text-black bg-white w-fit text-xl">2026 - Trigger Warning - Single: 
          <a href="https://unitedmasters.com/m/trigger-warning-1" className="text-red-500"> Listen</a> 
        </p>
