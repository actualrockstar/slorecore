  ...
  return (
    <div className="items-left justify-items-left min-h-screen p-8 sm:p-20 ">
      <main className="flex flex-col row-start-2 items-left sm:items-start">
        ...
        <h1 className='bg-white w-fit text-xl'>Here is some choice photos for your viewing. For video you should just go to <a href="https://www.youtube.com/@slorec0re">youtube</a> bro.</h1>
        <br></br>
